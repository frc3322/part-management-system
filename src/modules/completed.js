...
export function renderCompleted() {
    ...
    if (appState.loadingTab === 'completed' || (appState.isLoading && appState.parts.completed.length === 0)) {
        emptyMsg.classList.remove("hidden");
        emptyMsg.innerHTML = '<div class="flex items-center justify-center"><i class="fa-solid fa-spinner fa-spin text-green-400 mr-2"></i> Loading completed parts...</div>';
        return;
    }
