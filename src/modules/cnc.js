...
function renderLoadingState(container) {
    ...
    loadingState.innerHTML = '<div class="flex items-center justify-center"><i class="fa-solid fa-spinner fa-spin text-blue-400 mr-2"></i> Loading CNC parts...</div>';
...
function renderPartCard(part, index, container) {
    ...
    card.className = "neumorphic-card p-5 flex flex-col gap-3 transform transition hover:scale-[1.02] duration-300";
...
export function renderCNC() {
    ...
    if (appState.loadingTab === 'cnc' || (appState.isLoading && appState.parts.cnc.length === 0)) {
